...
//
//     final deprem = depremFromJson(jsonString);

import 'dart:convert';

Deprem depremFromJson(String str) => Deprem.fromJson(json.decode(str));

String depremToJson(Deprem data) => json.encode(data.toJson());
